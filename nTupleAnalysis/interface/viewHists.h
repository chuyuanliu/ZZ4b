...
#define plotBDT(HIST)          \
  plotSyst(HIST)               \
      plotSyst(HIST##_BDT_kVV) \
          plotSyst(HIST##_BDT_kl)
...
namespace nTupleAnalysis
{
  ...
  public:
    ...
    plotBDT(SvB_MA_VHH_ps);
    plotBDT(card_mHH);
    plotBDT(card_V_pT);
    plotBDT(card_mH1_mH2);
    //  ONNX
    ...
    TH1F *gen_mHH;
    TH1F *gen_ptHH;
    TH1F *gen_mHH_noHLT_kl;
    TH1F *gen_ptHH_noHLT_kl;
    TH1F *gen_mHH_kl;
    TH1F *gen_ptHH_kl;
    TH1F *gen_mHH_noHLT_kVV;
    TH1F *gen_ptHH_noHLT_kVV;
    TH1F *gen_mHH_kVV;
    TH1F *gen_ptHH_kVV;
